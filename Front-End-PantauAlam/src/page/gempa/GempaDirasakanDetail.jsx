...
function GempaDirasakanDetail() {
    const [open, setOpen] = useSidebar();
    const { Coordinates } = useParams();
    const [gempa, setGempa] = useState(null);
    useEffect(() => {
        fetch(`http://localhost:8000/api/gempa/gempadirasakan/${Coordinates}`)
    ...
    return (
        <>
            <div className="flex">
                ...
                <Main open={open}>
                    <Header label={`Gempa Dirasakan di ${gempa?.wilayah}`} />
...
export default GempaDirasakanDetail;
                ...
                {totalHalaman > 1 && (
                    <div className="flex justify-center items-center gap-4 mt-10">
                        <button
                            ...
                            className="px-4 py-2 bg-gray-200 text-gray-700 font-semibold rounded-lg disabled:opacity-50 hover:bg-gray-300 transition"
                        >
                            ◀ Sebelumnya
                        </button>
                        <span className="text-sm text-gray-600">
                            Halaman <strong>{halaman}</strong> dari {totalHalaman}
                        </span>
                        <button
